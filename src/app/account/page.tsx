...
export default async function AccountPage() {
  const [account, usage] = await Promise.all([
    getJson<AccountResponse>(`${process.env.NEXT_PUBLIC_SITE_URL || "https://picturebackgroundremover.xyz"}/api/account/me`),
    getJson<UsageResponse>(`${process.env.NEXT_PUBLIC_SITE_URL || "https://picturebackgroundremover.xyz"}/api/account/usage`),
  ]);
